      ...
      {unmappedTransactions.some((txn) => txn.detectedWorkspaceId) ? (
        <Box sx={{mb: 3, p: 2, backgroundColor: 'info.light', borderRadius: 1}}>
          ...
          <Typography variant="caption" color="text.secondary">
            Workspaces have been automatically detected for some transactions. You can override them below if needed.
          </Typography>
        </Box>
      ) : null}
                  ...
                  <Autocomplete<Category, false, false, false>
                    ...
                    renderInput={(params) => (
                      <TextField
                        ...
                        inputProps={{
                          ...params.inputProps,
                          title: categories.find((cat) => cat.id === mapping.categoryId)?.name ?? '',
                        }}
                      />
                    )}
                  />
