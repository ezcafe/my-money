...
export type {AccountEventPayloads, AccountEventEmitter} from './AccountEvents';
export type {CategoryEventPayloads, CategoryEventEmitter} from './CategoryEvents';
 ...
 */
export const accountEventEmitter = new TypedEventEmitter<AccountEventPayloads>();

/**
 * Global category event emitter instance
 * Use this to emit and listen to category events
 */
export const categoryEventEmitter = new TypedEventEmitter<CategoryEventPayloads>();
